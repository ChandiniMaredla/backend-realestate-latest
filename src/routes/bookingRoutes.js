...
const { createBooking,getBookingByFilters,getBuyerBookings, createAgentBooking,getByFilters,getBookingByName, rebookingWithAgent,getUserBookingsByStatus, getUserBookings, getAgentBookings,deleteappointment, updateBookingStatus, updateStatus, getBookingByUserAndAgent } = require('../controllers/bookingController'); // Import as an object
...
bookingRoutes.get('/getbookingsbystatus/:role/:status',getUserBookingsByStatus);
...
bookingRoutes.put('/updatebookingstatus/:bookingid/:status',updateBookingStatus);

bookingRoutes.delete('/delete',deleteappointment);
